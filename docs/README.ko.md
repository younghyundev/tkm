...
코딩 세션 중 야생 포켓몬을 만날 수 있습니다. 전투는 타입 상성 기반이며, 원작 게임의 스탯(HP, 공격, 방어, 스피드)을 사용합니다. 승리하면 보너스 XP를 획득하고, 포켓몬볼을 던져 포획을 시도할 수 있습니다. 포획률은 4세대 원작 공식을 따릅니다.

## 업적 시스템

21개 업적으로 총 XP, 포획 수, 진화, 특수 조건 등의 마일스톤을 추적합니다. 업적 달성 시 희귀 포켓몬 잠금해제, 포켓몬볼, XP 보너스, 파티 슬롯 추가 등의 보상을 받습니다.
